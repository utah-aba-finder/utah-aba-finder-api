# Inline script to delete duplicate providers for SJ Childs
# Run with: heroku run rails runner "$(cat scripts/delete_duplicates_inline.rb)" --app utah-aba-finder-api

keep_id = 1262
duplicate_ids = [1261, 1260, 1259, 1258, 1257, 1256, 1255]
